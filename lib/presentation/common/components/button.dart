...
class _UiBaseButtonStyle extends ButtonStyle {
  ...
  WidgetStateProperty<double>? get iconSize =>
      const WidgetStatePropertyAll<double>(18);
        ...
        (Set<WidgetState> states) {
          if (states.contains(WidgetState.disabled)) {
            return RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(8),
              side: BorderSide(
                color: colorPalette.foreground.withOpacity(0.12),
              ),
            );
          }
...
class _IconButtonBaseStyle extends _UiBaseButtonStyle {
  ...
  @override
  WidgetStateProperty<EdgeInsetsGeometry>? get padding =>
      const WidgetStatePropertyAll<EdgeInsetsGeometry>(EdgeInsets.all(8));
  ...
  @override
  WidgetStateProperty<double>? get iconSize =>
      const WidgetStatePropertyAll<double>(24);
}
